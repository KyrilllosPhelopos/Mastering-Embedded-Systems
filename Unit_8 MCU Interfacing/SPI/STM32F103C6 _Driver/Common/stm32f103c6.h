...
//USART2
#define RCC_SPI2_CLK_EN()	(RCC->APB1ENR |= 1 << 14)  //SPI2 enable is in bit 14
//USART3
#define RCC_SPI3_CLK_EN()	(RCC->APB1ENR |= 1 << 15)  //SPI3 enable is in bit 15
...
#define RCC_SPI1_CLK_DI()	(RCC->APB2RSTR |= 1 << 12)  //SPI1 disable is in bit 12
#define RCC_SPI2_CLK_DI()	(RCC->APB1RSTR |= 1 << 14)  //SPI2 disable is in bit 14
#define RCC_SPI3_CLK_DI()	(RCC->APB1RSTR |= 1 << 15)  //SPI3 disable is in bit 15
...
//SPI
#define NVIC_IRQ35_SPI1_EN()		(NVIC_ISER1 |= 1<<(SPI1_IRQ - 32)) // enable NVIC FOR SPI1
#define NVIC_IRQ36_SPI2_EN()		(NVIC_ISER1 |= 1<<(SPI2_IRQ - 32)) // enable NVIC FOR SPI2
#define NVIC_IRQ51_SPI3_EN()		(NVIC_ISER1 |= 1<<(SPI3_IRQ - 32)) // enable NVIC FOR SPI3
...
//SPI
#define NVIC_IRQ35_SPI1_DI()		(NVIC_ICER1 |= 1<<(SPI1_IRQ - 32)) // disable NVIC FOR SPI1
#define NVIC_IRQ36_SPI2_DI()		(NVIC_ICER1 |= 1<<(SPI2_IRQ - 32)) // disable NVIC FOR SPI2
#define NVIC_IRQ51_SPI3_DI()		(NVIC_ICER1 |= 1<<(SPI3_IRQ - 32)) // disable NVIC FOR SPI3
