...
void MCAL_UART_SendData(USART_TypeDef* USARTx, uint8_t* pTxBuffer, enum Polling_Mechanism PollingEn);
void MCAL_UART_ReceiveData(USART_TypeDef* USARTx, uint8_t* pRxBuffer, enum Polling_Mechanism PollingEn);
